 ...
 */
public class TelaBinarizacaoOtsu extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TelaBinarizacaoOtsu
     */
    public TelaBinarizacaoOtsu(){
        initComponents();
...
//        tomatoIconBin2.setIcon(icon);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Binarização de Otsu em Imagem de uma Pasta");
                    ...
                    for(File arqPastaOrigem: pastaOrigem.listFiles()){
                            ...
                            (btnBmpOption.isSelected() && arqPastaOrigem.getName().toLowerCase().endsWith(".bmp")))
                        {
                            try {
                                ...
                                BufferedImage imagemProcessada = ProcessamentoImagem.BinarizacaoOtsu(imgOriginal);
                                
                                File fo;
                                if(arqPastaOrigem.getName().length() >= 16){
                                    String finalRedness = "RedTomatoLaC.png";
                                    if(finalRedness.equals(arqPastaOrigem.getName().substring(arqPastaOrigem.getName().length()-16)))
                                        fo = new File(pastaDestino.getPath()+"/"+arqPastaOrigem.getName().substring(0, arqPastaOrigem.getName().length() - 17)+"_Otsu"+".png");
                                    else
                                        fo = new File(pastaDestino.getPath()+"/"+arqPastaOrigem.getName().substring(0, arqPastaOrigem.getName().length() - 4)+"_Otsu"+".png");
                                }
                                else{
                                    fo = new File(pastaDestino.getPath()+"/"+arqPastaOrigem.getName().substring(0, arqPastaOrigem.getName().length() - 4)+"_Otsu"+".png");
                                }
    ...
    public static void main(String args[]) throws MalformedURLException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBinarizacaoOtsu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBinarizacaoOtsu().setVisible(true);
            }
        });
    }
